import { iniciarTablero1, iniciarTablero2, iniciarTableroAtaque } from "./tableros.js";
      ...
      while (!coordenadasGeneradas) {
        ...
        if (!coordOcupadas1.includes([fila2, columna2])) {
          ...
          if (
            ...
            matrizJug1[fila2B2J1][columna2B2J1] != "X" &&
            matrizJug1[fila3B2J1][columna3B2J1] != "X" &&
            ...
            matrizJug1[fila1B2J1][columna1B2J1] = "Z";
            matrizJug1[fila2B2J1][columna2B2J1] = "Z";
            matrizJug1[fila3B2J1][columna3B2J1] = "Z";
            matrizJug1[fila4B2J1][columna4B2J1] = "Z";
    ...
    for (let i = 0; i < 1; i++) {
      ...
      while (!coordenadasGeneradas) {
        ...
        if (!coordOcupadas1.includes([fila5, columna5])) {
          ...
          // Si la coordenada no esta ocupada por los otros barcos se ubica en esa posición
          if (
            matrizJug1[fila1B5J1][columna1B5J1] != "X" &&
            ...
            matrizJug1[fila2B5J1][columna2B5J1] != "X" &&
            ...
            matrizJug1[fila3B5J1][columna3B5J1] != "X" &&
            ...
            matrizJug1[fila4B5J1][columna4B5J1] != "X" &&
            ...
            matrizJug1[fila5B5J1][columna5B5J1] != "X" &&
            ...
            matrizJug1[fila1B5J1][columna1B5J1] = "A";
            matrizJug1[fila2B5J1][columna2B5J1] = "A";
            matrizJug1[fila3B5J1][columna3B5J1] = "A";
            matrizJug1[fila4B5J1][columna4B5J1] = "A";
            matrizJug1[fila5B5J1][columna5B5J1] = "A";
...
export function coordenadasB1J2(matrizJug2) {
    ...
    // Se asignan las coordenadas a la matriz
    matrizJug2[fila1B1J2][columna1B1J2] = "X";
    matrizJug2[fila2B1J2][columna2B1J2] = "X";
    matrizJug2[fila3B1J2][columna3B1J2] = "X";
  };
    ...
    for (let i = 0; i < 1; i++) {
      ...
      while (!coordenadasGeneradas) {
        ...
        if (!coordOcupadas1.includes([fila2, columna2])) {
          ...
          if (
            matrizJug2[fila1B2J2][columna1B2J2] != "X" &&
            matrizJug2[fila2B2J2][columna2B2J2] != "X" &&
            matrizJug2[fila3B2J2][columna3B2J2] != "X" &&
            matrizJug2[fila4B2J2][columna4B2J2] != "X"
          ) {
            // En caso de cumplirse la condición se ingresan a los arrays
...
export function coordenadasB3J2(matrizJug2) {
    ...
    for (let i = 0; i < 1; i++) {
      ...
      while (!coordenadasGeneradas) {
        ...
        // Si la coordenada no esta ocupada por los otros barcos se ubica en esa posición
        if (
          matrizJug2[fila1B3J2][columna1B3J2] != "X" &&
...
export function coordenadasB4J2(matrizJug2) {
    ...
    for (let i = 0; i < 1; i++) {
      ...
      while (!coordenadasGeneradas) {
        ...
        // Si la coordenada no esta ocupada por los otros barcos se ubica en esa posición
        if (
          matrizJug2[fila1B4J2][columna1B4J2] != "X" &&
